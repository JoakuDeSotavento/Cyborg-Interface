...
import netP5.*;
OscP5 oscP5;
NetAddress myRemoteLocation, myRemoteLocation2, myRemoteArduino, myRemoteReso, remoteWekiAudio;
...
void setup() {
  ...
  /// adress for wekinator helper2 this is for resolume
  myRemoteLocation2 = new NetAddress("127.0.0.1", 11000);
  ...
  myRemoteReso = new NetAddress("192.168.43.204", 3000);
...
void outputData() {
  ...
  float processHeight7 = map(p7, 0, 1, 0, 200);
  rect(1020, 250, 50, -processHeight7);
  float processHeight8 = map(p8, 0, 1, 0, 200);
  rect(1090, 250, 50, -processHeight8);
  float processHeight9 = map(p9, 0, 1, 0, 200);
  rect(1160, 250, 50, -processHeight9);
  popStyle();
  ...
  text("GAIN-F", 950, 270);
  text(p6, 950, 290);
  text("OPACITY", 1020, 270);
  text(p7, 1020, 290);
  text("SPEED", 1090, 270);
  text(p8, 1090, 290);
  text("DIRECTION", 1160, 270);
  text(p9, 1160, 290);
  popStyle();
}
