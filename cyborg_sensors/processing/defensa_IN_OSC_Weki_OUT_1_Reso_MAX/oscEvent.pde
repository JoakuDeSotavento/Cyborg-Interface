...
void oscEvent(OscMessage theOscMessage) {
  ...
  if (theOscMessage.checkAddrPattern("/processing")==true) {
    if (theOscMessage.checkTypetag("ffffffffff")) { //Now looking for 10 parameters
      ...
      p7 = theOscMessage.get(7).floatValue(); //get third parameters
      p8 = theOscMessage.get(8).floatValue(); //get third parameters
      p9 = theOscMessage.get(9).floatValue(); //get third parameters
  ...
  //////// messages for MAX
  sendOSC(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, false);
  //////// messages for RESOLUME
  sendOSC(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, true);
}
