void sendOSC(float _p0, float _p1, float _p2, float _p3, float _p4, float _p5, float _p6, boolean _bunOrMess) {
  if (!_bunOrMess) {
    ...
    myMessage.setAddrPattern("/osc/1/frequency");
    ...
    myMessage.setAddrPattern("/osc/1/pulse/level");
    myMessage.add((float)_p1);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/osc/1/sine/level");
    myMessage.add((float)_p2);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/osc/2/frequency");
    myMessage.add((float)_p3);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/osc/2/pulse/level");
    myMessage.add((float)_p4);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/osc/2/sine/level");
    myMessage.add((float)_p5);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/osc/12/sine/level");
