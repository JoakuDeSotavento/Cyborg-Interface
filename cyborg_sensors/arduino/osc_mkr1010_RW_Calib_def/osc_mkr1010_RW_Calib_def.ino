...
//  int sensorValue6 = analogRead(A6);
  ...
  ///// building a bundle
  buffer.unshift(senVal[0]);
  buffer1.unshift(senVal[1]);
  buffer2.unshift(senVal[2]);
  buffer3.unshift(senVal[3]);
  buffer4.unshift(senVal[4]);
  buffer5.unshift(senVal[5]);
  buffer6.unshift(senVal[6]);
