void sendOSC(float _p0, float _p1, float _p2, float _p3, float _p4, float _p5, float _p6, boolean _bunOrMess) {
  if (_bunOrMess == true) {
    ...
    OscMessage myMessage = new OscMessage("/composition/layers/3/clips/1/video/source/linescape/height");
    ...
    myMessage.setAddrPattern("/composition/layers/3/clips/1/video/source/linescape/tilt");
    myMessage.add((float)_p1);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/composition/layers/3/clips/1/video/source/linescape/jagginess");
    myMessage.add((float)_p2);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/composition/layers/2/clips/1/video/source/linescape/height");
    myMessage.add((float)_p3);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/composition/layers/2/clips/1/video/source/linescape/tilt");
    myMessage.add((float)_p4);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/composition/layers/2/clips/1/video/source/linescape/jagginess");
    myMessage.add((float)_p5);
    myBundle.add(myMessage);
    myMessage.clear();
    /* refill the osc message object again */
    myMessage.setAddrPattern("/composition/layers/2/clips/1/video/source/linescape/positiony");
