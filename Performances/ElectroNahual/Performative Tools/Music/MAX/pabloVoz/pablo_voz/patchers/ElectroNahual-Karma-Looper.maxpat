...
, 							{
								"box" : 								{
									"id" : "obj-83",
									"items" : [ "port", 16000, ",", "port", 17000, ",", "port", 16000, ",", "port", 17000, ",", "port", 16000, ",", "port", 17000 ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									"id" : "obj-77",
									"items" : [ "port", 9000, ",", "port", 8000, ",", "port", 7000, ",", "port", 9000, ",", "port", 8000, ",", "port", 7000, ",", "port", 9000, ",", "port", 8000, ",", "port", 7000 ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									"id" : "obj-66",
									"items" : [ "port", 2000, ",", "port", 3000, ",", "port", 12000, ",", "port", 13000, ",", "port", 2000, ",", "port", 3000, ",", "port", 12000, ",", "port", 13000, ",", "port", 2000, ",", "port", 3000, ",", "port", 12000, ",", "port", 13000 ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
